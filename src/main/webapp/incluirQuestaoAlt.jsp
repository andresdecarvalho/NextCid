					...
					<div class="card-body">
						...
						<form action="ServletQuestao" method="get">
							...
							<div class="form-group" style="text-align: left">
								...
								<input type="text" class="form-control" name="anoQuestao"
									size="60" maxlength="60"><br>
								<label>Número da Questão:</label> <input type="text"
									class="form-control" name="nQuestao" size="60" maxlength="60"><br>
								...
								<label>Objetiva A:</label> <input type="text"
									class="form-control" name="altA" size="60"><br>
								<label>Objetiva B:</label> <input type="text"
									class="form-control" name="altB" size="60"><br>
								<label>Objetiva C:</label> <input type="text"
									class="form-control" name="altC" size="60"><br>
								<label>Objetiva D:</label> <input type="text"
									class="form-control" name="altD" size="60" ><br>
								<label>Objetiva E:</label> <input type="text"
									class="form-control" name="altE" size="60"><br>
