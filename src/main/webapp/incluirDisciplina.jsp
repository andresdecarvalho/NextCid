						...
						<ul class="collapse list-unstyled" id="pageSubmenu1">
							<li><a href="#pageSubmenu2" data-toggle="collapse"
								aria-expanded="false" class="dropdown-toggle"> <svg
                                    ...
                                    <path
											d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2zm10-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1z" />
                                    </svg> &nbsp;Incluir Quest�es
							</a>
								<ul class="collapse list-unstyled" id="pageSubmenu2">
									<li><a style="margin-left: 15px"
										href="incluirQuestaoDiss.jsp">Quest�es Dissertativas</a></li>
									<li><a style="margin-left: 15px"
										href="incluirQuestaoAlt.jsp">Quest�es Objetivas</a></li>
								</ul></li>
                  ...
                  <div class="form-group" style="text-align: left">
                    ...
                    <label>Curso Relacionado:</label><br>
                        ...
                        <select  name="idCurso" required class="form-control" aria-label="Default select example">
                            ...
                            <option required value=<%=a.getIdCurso()%>><%=a.getNomeCurso()%></option>
